  ...
  return (
    <>
      <MetaTags
        ...
        description={playlist.description || `Playlist de ${playlist.user?.name} en MyBandLab`}
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-3 mt-6">
                  ...
                  <ShareButtons
                    title={playlist.title}
                    description={
                      playlist.description || `Playlist de ${playlist.user.name} en MyBandLab`
                    }
                    url={`/playlists/${playlist.id}`}
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <ShareSongButton
                        ...
                        songTitle={playlistSong.song.title}
                        artistName={playlistSong.song.artist?.stageName}
                        groupName={playlistSong.song.musicGroup?.name}
                      />
                      <button
                        onClick={() => {
                          const playlistSongs = songs.map((ps) => ({
