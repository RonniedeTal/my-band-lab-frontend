...
export const GroupDetailPage: React.FC = () => {
  ...
  return (
    <>
      <MetaTags
        title={group.name}
        description={group.description || `Escucha la música de ${group.name} en MyBandLab`}
        image={group.logoUrl}
        url={`/groups/${group.id}`}
        type="music.song"
      />
        ...
        <div className="container mx-auto px-4 py-8">
              ...
              <div className="flex gap-3 flex-wrap">
                ...
                {user && !isFounder && (
                  <>
                    ...
                    {/* Botón de compartir grupo */}
                    <div className="mt-4">
                      <ShareButtons
                        title={group.name}
                        description={
                          group.description || `Escucha la música de ${group.name} en MyBandLab`
                        }
                        url={`/groups/${group.id}`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              {/* 🔵 BOTONES DE COMPARTIR - AÑADIR AQUÍ */}
              <div className="bg-gray-800/30 rounded-xl p-6">
                <h3 className="text-lg font-semibold text-white mb-4">Compartir</h3>
                <ShareButtons
                  title={group.name}
                  description={
                    group.description || `Escucha la música de ${group.name} en MyBandLab`
